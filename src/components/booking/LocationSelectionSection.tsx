  ...
  return (
    <div className="space-y-2">
      ...
      <Select value={selectedLocationId} onValueChange={handleLocationChange}>
        <SelectTrigger className="w-full mx-0 my-0 py-[2px] px-[8px] text-base font-medium text-left rounded-sm bg-white border-gray-200 hover:bg-gray-50 focus:ring-gray-200 focus:border-gray-300">
